...
function setupDownloadButton() {
    ...
    const processCapture = (mode) => {
        ...
        // 2. Calcolo padding per rendere la preview quadrata
        ...
        // Applica margine dinamico per forzare il quadrato
        ...
        // FIX CHIAVE: Ridotto il padding esterno al minimo (10px / 5px)
        const paddingValue = (mode === 'png-transparent') ? '5px' : '10px'; 
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const wm = document.getElementById('card-watermark');
    if(wm) wm.style.display = 'block';
>>>>>>> 0ad5bd9f2b08d7bd95046ebb5a8987ec6e921606
});